/**
 * @file  aux.c
 * @brief Implementation of utility functions for grid initialization.
 */
...
/**
 * @brief Initializes grid arrays with a default value.
 *
...
/**
 * @brief Initializes the local grid portion with boundary conditions.
 *
